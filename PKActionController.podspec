#
#  Be sure to run `pod spec lint PKActionController.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "An alert controller that displays an alert message with attributed style to the user with custom configuration."

  spec.homepage     = "https://github.com/pvn/PKActionController"
  ...
  spec.source       = { :git => "https://github.com/pvn/PKActionController.git", :tag => spec.version.to_s }
